  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50 flex flex-col items-center py-12 px-4">
      <div className="w-full max-w-3xl mb-8 text-center">
        ...
        <p className="text-lg text-gray-600">Create, preview, and download professional PDF documents in seconds</p>
      </div>
      
      <PDFForm />
      
      <div className="mt-12 text-sm text-gray-500 text-center">
        <p>Fill in the form with your information, generate a PDF, then preview or download it.</p>
